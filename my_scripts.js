...
function loadStatsPage(){
		...
		{//Outer for loop iterates over each row
				...
				cell_value1 = parseInt(table.rows[row_counter].cells[2].innerHTML);//Read in a cells current value
				cell_value2 = parseInt(table.rows[row_counter].cells[3].innerHTML);//Increase the cell's value by 2
...
function loadPlayersPage(){
	...
	for(x=0; x<players.length; x++){
		anchor +="<a class=\"dropdown-item\" href=\"#\" onclick=\"switchPlayers(" + x + ")\">" + players[x].name + "</a>";
	}
